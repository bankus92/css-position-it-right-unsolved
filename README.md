...
- [o] Shapes must follow the guidelines:
  ...
  - [o] At least one shape should have a gradient background color chosen from the available [UI gradients](https://uigradients.com/).
  - [o] At least one shape should have a background image that fits the shape and doesn't overflow it, using images from [Lorem Picsum](https://picsum.photos/) or any other images CDN service.
  ...
  - [o] At least one shape should have an opacity of 50% or be semi-transparent.
